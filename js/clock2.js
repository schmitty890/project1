(() => {
  ...
  const displayCurrentTime = () => {
    ...
    if (days[day].length === 6)
      dayText = `<span style="color: #2b2828;">ooo</span>${days[day]}`;
    if (days[day].length === 7)
      dayText = `<span style="color: #2b2828;">oo</span>${days[day]}`;
    if (days[day].length === 8)
      dayText = `<span style="color: #2b2828;">o</span>${days[day]}`;
    if (days[day].length === 9)
      dayText = `<span style="color: #2b2828;"></span>${days[day]}`;
    //formats mobile day
